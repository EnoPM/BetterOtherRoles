...
using static BetterOtherRoles.CustomOption;
...
namespace BetterOtherRoles {
        ...
        public static void deserializeOptions(byte[] inputValues) {
            ...
            while (reader.BaseStream.Position < inputValues.Length) {
                try {
                    ...
                    BetterOtherRolesPlugin.Logger.LogWarning($"{e}: while deserializing - tried to paste invalid settings!");
                }
            }
        }
    ...
    class GameOptionsMenuStartPatch {
        public static void Postfix(GameOptionsMenu __instance) {
            ...
            pasteButtonRenderer.sprite = Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.PasteButton.png", 175f);
        ...
        private static void createClassicTabs(GameOptionsMenu __instance) {
            ...
            var impostorTabHighlight = getTabHighlight(impostorTab, "ImpostorTab", "BetterOtherRoles.Resources.TabIconImpostor.png");

            var neutralTab = UnityEngine.Object.Instantiate(roleTab, impostorTab.transform);
            var neutralTabHighlight = getTabHighlight(neutralTab, "NeutralTab", "BetterOtherRoles.Resources.TabIconNeutral.png");

            var crewmateTab = UnityEngine.Object.Instantiate(roleTab, neutralTab.transform);
            var crewmateTabHighlight = getTabHighlight(crewmateTab, "CrewmateTab", "BetterOtherRoles.Resources.TabIconCrewmate.png");

            var modifierTab = UnityEngine.Object.Instantiate(roleTab, crewmateTab.transform);
            var modifierTabHighlight = getTabHighlight(modifierTab, "ModifierTab", "BetterOtherRoles.Resources.TabIconModifier.png");
        ...
        private static void createGuesserTabs(GameOptionsMenu __instance) {
            ...
            var guesserTabHighlight = getTabHighlight(guesserTab, "GuesserTab", "BetterOtherRoles.Resources.TabIconGuesserSettings.png");
        ...
        private static void createHideNSeekTabs(GameOptionsMenu __instance) {
            ...
            var torTab = UnityEngine.Object.Instantiate(roleTab, gameTab.transform.parent);
            var torTabHighlight = getTabHighlight(torTab, "TheOtherRolesTab", "BetterOtherRoles.Resources.TabIconHideNSeekSettings.png");

            var hideNSeekTab = UnityEngine.Object.Instantiate(roleTab, torTab.transform);
            var hideNSeekTabHighlight = getTabHighlight(hideNSeekTab, "HideNSeekTab", "BetterOtherRoles.Resources.TabIconHideNSeekRoles.png");
        ...
        private static SpriteRenderer getTabHighlight (GameObject tab, string tabName, string tabSpritePath) {
            ...
            tab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Helpers.loadSpriteFromResources(tabSpritePath, 400f);
            tab.name = "tabName";
    ...
    public class HudManagerUpdate {
        ...
        public static void Prefix2(HudManager __instance) {
            ...
            for (int i = 0; i < blockCount; i++) {
                BetterOtherRolesPlugin.Logger.LogMessage(blockCount);
        ...
        public static void Postfix(HudManager __instance) {
            if (!toggleSettingsButton || !toggleSettingsButtonObject) {
                ...
                renderer.sprite = Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.CurrentSettingsButton.png", 180f);
