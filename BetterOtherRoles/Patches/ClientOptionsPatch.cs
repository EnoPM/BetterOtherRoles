...
namespace BetterOtherRoles.Patches 
{
    ...
    public static class ClientOptionsPatch
    {
        private static SelectionBehaviour[] AllOptions = {
            new SelectionBehaviour("Ghosts See Tasks & Other Info", () => TORMapOptions.ghostsSeeInformation = BetterOtherRolesPlugin.GhostsSeeInformation.Value = !BetterOtherRolesPlugin.GhostsSeeInformation.Value, BetterOtherRolesPlugin.GhostsSeeInformation.Value),
            new SelectionBehaviour("Ghosts Can See Votes", () => TORMapOptions.ghostsSeeVotes = BetterOtherRolesPlugin.GhostsSeeVotes.Value = !BetterOtherRolesPlugin.GhostsSeeVotes.Value, BetterOtherRolesPlugin.GhostsSeeVotes.Value),
            new SelectionBehaviour("Ghosts Can See Roles", () => TORMapOptions.ghostsSeeRoles = BetterOtherRolesPlugin.GhostsSeeRoles.Value = !BetterOtherRolesPlugin.GhostsSeeRoles.Value, BetterOtherRolesPlugin.GhostsSeeRoles.Value),
            new SelectionBehaviour("Ghosts Can Additionally See Modifier", () => TORMapOptions.ghostsSeeModifier = BetterOtherRolesPlugin.GhostsSeeModifier.Value = !BetterOtherRolesPlugin.GhostsSeeModifier.Value, BetterOtherRolesPlugin.GhostsSeeModifier.Value),
            new SelectionBehaviour("Show Role Summary", () => TORMapOptions.showRoleSummary = BetterOtherRolesPlugin.ShowRoleSummary.Value = !BetterOtherRolesPlugin.ShowRoleSummary.Value, BetterOtherRolesPlugin.ShowRoleSummary.Value),
            new SelectionBehaviour("Show Lighter / Darker", () => TORMapOptions.showLighterDarker = BetterOtherRolesPlugin.ShowLighterDarker.Value = !BetterOtherRolesPlugin.ShowLighterDarker.Value, BetterOtherRolesPlugin.ShowLighterDarker.Value),
            new SelectionBehaviour("Enable Sound Effects", () => TORMapOptions.enableSoundEffects = BetterOtherRolesPlugin.EnableSoundEffects.Value = !BetterOtherRolesPlugin.EnableSoundEffects.Value, BetterOtherRolesPlugin.EnableSoundEffects.Value),
        };
